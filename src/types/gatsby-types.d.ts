...
type PartyRelationshipFieldSelector = {
  readonly party: InputMaybe<PartyFieldSelector>;
  readonly relationship: InputMaybe<FieldSelectorEnum>;
};

type PartyRelationshipFilterInput = {
  readonly party: InputMaybe<PartyFilterInput>;
  readonly relationship: InputMaybe<StringQueryOperatorInput>;
};

type PartyRelationshipFilterListInput = {
  readonly elemMatch: InputMaybe<PartyRelationshipFilterInput>;
};

type PartyRelationshipSortInput = {
  readonly party: InputMaybe<PartySortInput>;
  readonly relationship: InputMaybe<SortOrderEnum>;
};
...
type NotFoundQuery = { readonly campaigns: { readonly nodes: ReadonlyArray<{ readonly name: string }> } };
...
type NpcsListQuery = { readonly npcs: { readonly nodes: ReadonlyArray<{ readonly name: string, readonly slug: string, readonly race: string | null, readonly occupation: ReadonlyArray<string | null> | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null }> } };

type QuestDetailQueryVariables = Exact<{
  id: Scalars['String'];
}>;
...
type SessionsListQuery = { readonly sessions: { readonly nodes: ReadonlyArray<{ readonly name: string, readonly slug: string, readonly summary: string | null, readonly sessionDate: string | null, readonly sessionNumber: number | null }> } };
